        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700">
              <strong>Phantom wallet not detected.</strong> Make sure:
            </p>
            <ul className="mt-2 text-sm text-yellow-700 list-disc list-inside">
              <li>Phantom extension is installed and enabled</li>
              <li>Refresh this page after enabling Phantom</li>
              <li>Check browser extensions settings</li>
            </ul>
          </div>
        </div>
      </div>
